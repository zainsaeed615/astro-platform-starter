		...
		wp_localize_script(
			...
			array(
				...
				'i18n'     => array(
					...
					'modalTitleUpload'    => __( 'Upload Shipment History', 'mdr-ai-carrier-intelligence' ),
					'modalTitleProcessing' => __( 'Analyzing Your Data', 'mdr-ai-carrier-intelligence' ),
					'modalTitleReport'    => __( 'Your Intelligence Report', 'mdr-ai-carrier-intelligence' ),
				),
				'colors'   => array(
